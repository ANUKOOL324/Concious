const consumeCards = [
  {
    ...
    items: [
      "Save YouTube, Twitter/X, Spotify, articles, and PDFs",
      "Add notes, tags, collections, and why you saved it",
      "Upload PDFs and reopen them from your dashboard",
      "Keep every useful link in one calm vault",
    ],
    mobileItems: [
      "Save videos, links, and PDFs",
      "Add notes, tags, and why saved",
      "Reopen PDFs from your vault",
  ...
  },
  {
    ...
    items: [
      "Semantic search by meaning across indexed content",
      "Ashqnor answers from your own saved sources",
      "Ask questions grounded in what you already saved",
      "Find connections across ideas more quickly",
    ],
    mobileItems: [
      "Search your library by meaning",
      "Ashqnor uses your saved sources",
      "Ask grounded questions",
      "Spot idea connections faster",
    ],
  },
  {
